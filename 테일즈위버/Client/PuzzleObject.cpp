...
HRESULT CPuzzleObject::Initialize()
{
	return S_OK;
}

int CPuzzleObject::Update()
{
	// 아이템 무게
...
HRESULT CPuzzleObject::LateInit()
{
...
void CPuzzleObject::Release()
{
}

void CPuzzleObject::FrameOnceEnd()
{
}

void CPuzzleObject::FrameEvent()
{
}
