...
public:
	...
	void	Render_Begin();
	void	Render_End();
	void	DrawFont(const wstring& wstrText, RECT* rt = nullptr, UINT iOption = 0, DWORD dwFontColor = D3DCOLOR_ARGB(255, 255, 255, 255));
...
private:
	...
	// ID3DXFont의 포인터
	// ID3DXFont : 다이렉트 상에서 2D폰트 렌더링을 수행하는 Com객체
